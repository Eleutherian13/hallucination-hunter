...
const features = [
  {
    ...
    description:
      "Eight specialized layers working in concert to detect hallucinations with high accuracy.",
  },
  {
    icon: Target,
    title: "Precise Citations",
    description:
      "Direct links to exact paragraphs in source documents that validate each claim.",
  },
  {
    icon: Zap,
    title: "Intelligent Corrections",
    description:
      "AI-powered suggestions to fix hallucinated content based on actual source material.",
  },
  {
    icon: GitBranch,
    title: "Full Explainability",
    description:
      "Clear explanations for every flag: why, where, and how confident.",
  },
];
    ...
    >
      ...
      >
        ...
        <div className="relative glass-card p-8 md:p-12">
          <div className="max-w-3xl">
            ...
            >
              Verify LLM outputs against source documents with our 8-layer AI
              verification pipeline. Detect hallucinations, get citations, and
      ...
      >
        {features.map((feature, idx) => (
          ...
          >
            <div
              className={`w-12 h-12 rounded-xl bg-gradient-to-br ${feature.icon === Shield ? "from-blue-500 to-blue-600" : feature.icon === Target ? "from-purple-500 to-purple-600" : feature.icon === Zap ? "from-green-500 to-green-600" : "from-orange-500 to-orange-600"} flex items-center justify-center mb-4`}
            >
